...
export const EXERCISE_CATALOG = [
  ...
  // Aggiunta: panca inclinata con bilanciere
  ...
  // Aggiunte richieste (glutei/anche -> modality "Gambe")
  { id: slug("Slanci ai Cavi"),           name: "Slanci ai Cavi",           muscle: "Gambe",   equipment: "Cavi",       modality: "Gambe" },
  ...
  // Extra popolari (ridondanti per più scelta UI)
...
export function detectGroup(name) {
  ...
  const rules = [
    ...
    [/squat|affondi|pressa|stacchi|deadlift|leg|quad|hamstring|calf|polpacci|glute|hip thrust|abductor|crab/, "Gambe"],
